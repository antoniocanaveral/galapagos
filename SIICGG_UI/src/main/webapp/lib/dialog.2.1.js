...
Dialog.prototype = {
    ...
    attachEvents:function(){
        ...
        else if(Object.isArray(this.opt.handle)) this.opt.handle.each(function(handle){
            handles.push($(handle));
        });
    ...
    setContent:function(inContent){
        var c = (inContent==undefined)?this.opt.content:inContent,
        t = Dialogs.elm('content');
        t.update('');
        if(Object.isString(c) || Object.isElement(c)) t.insert(c);
        else if(Object.isArray(c)) c.each(function(b){
            t.insert(b);
        });
        else if(Object.isHash(c)){
