...
/*
 *ESATDO PARA LA ADMINISTRACION DE BECA
 *
 */
var TypeCiclo=
{
...
var dsRptTipoOperacion = [[0,'Entrada'],[1,'Salida'],[2,'Ambas']];
...
var dsTipoAccionVehiculo = [[0,'Nuevo'],[1,'Existente']];
...
var dsEstadoPermitidoNotificacion = [[0,'No Permitido'],[1,'Permitido'],[2,'Ambos']];
var dsUbicacion = [[0,'Dentro'],[1,'Fuera'],[2,'Ambos']];
var dsTipoPeriodoGem  = [[2,'Por fechas'],[0,'Anual'],[1,'Mensual']];
var dsFiltroGem  = [[0,'Por Isla'],[1,'Sector'],[2,'Por Sector/Isla']];
var dsCandidatosGem  = [[0,'Aplicados'],[1,'Ubicados'],[2,'Rechazados']];
...
var dsCategoriaTCT=[['CRTST6','Turista'],['CRTST7','Transeunte']];
...
function Persona(){
    ...
    cm =new Ext.grid.ColumnModel([
        ...
        {dataIndex:'CRPER_AUTORIZADO',header:'Autorizado',width:150,sortable:true}
    ]);
...
function Cgg_res_miembro_usuario(){
    ...
    cmCgg_res_miembro_usuario = new Ext.grid.ColumnModel([
        ...
        {dataIndex:'CUSU_EMPRESA',header:'Codigo',width:150,sortable:true,hidden:true},
        ...
        {dataIndex:'CPRR_CODIGO',header:'Nombre',width:150,sortable:true,hidden:true},
        {dataIndex:'PARROQUIA',header:'Parroquia',width:150,sortable:true},
        {dataIndex:'CCTN_CODIGO',header:'Nombre',width:150,sortable:true,hidden:true},
...
function Cgg_res_regla_validacion_lite(){
    ...
    cmCgg_res_regla_validacion_lite = new Ext.grid.ColumnModel([
        {dataIndex:'CRVAL_NOMBRE',header:'Nombre',width:200,sortable:true},
        {dataIndex:'CRVAL_DESCRIPCION',header:'Descripci\u00f3n',width:250,sortable:true,hidden:true},
        {dataIndex:'CRVAL_FUNCION_VALIDACION',header:'Funci\u00f3n validaci\u00f3',width:150,sortable:true},
        {dataIndex:'CRVAL_FUNCION_PLSQL_PARAMETROS',header:'Parametros',width:150,sortable:true,hidden:true}
    ]);
...
function Cgg_usuario(){
    ...
    var chkUsuarioInterno = new Ext.grid.CheckColumn(
		{dataIndex:'CUSU_USUARIO_INTERNO',header:'Usuario interno',width:150,sortable:true}
	);
...
function Cgg_usuario_responsable_Empresa(){
    ...
    this.columnModel = new Ext.grid.ColumnModel([
		...
		{dataIndex:'CISLA_NOMBRE',header:'Isla',sortable:true},
		{dataIndex:'CRPJR_ACTIVIDAD',header:'Actividad',width:200,sortable:true}
	]);
}
