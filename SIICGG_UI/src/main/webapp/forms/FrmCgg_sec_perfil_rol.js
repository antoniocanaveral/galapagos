...
function FrmCgg_sec_perfil_rol(INSENTENCIA_CGG_SEC_PERFIL_ROL, INRECORD_CGG_SEC_PERFIL_ROL) {  
    ...
    var urlCgg_sec_perfil_rol = URL_WS + "Cgg_sec_perfil_rol";
    ...
    /**
     * Boton que permite almacenar la informacion de la ventana winFrmCgg_sec_perfil_rol
     */
            ...
            click: function () {
                ...
                try {
                    function CallBackCgg_sec_perfil_rol(r) {
                        winFrmCgg_sec_perfil_rol.getEl().unmask();
                        if (r == 'true') {
                            Ext.Msg.show({
                            ...
                            winFrmCgg_sec_perfil_rol.close()
                        } else {
                            Ext.Msg.show({
                                title: tituloCgg_sec_perfil_rol,
                    ...
                    winFrmCgg_sec_perfil_rol.getEl().mask('Guardando...', 'x-mask-loading');
                    var param = new SOAPClientParameters();
                    if (isEdit) param.add('inCsper_codigo', txtCsper_codigo.getValue());
                    param.add('inCsrol_codigo', tmpRol);
                    param.add('inCsprf_codigo', tmpPerfil);
                    SOAPClient.invoke(urlCgg_sec_perfil_rol, INSENTENCIA_CGG_SEC_PERFIL_ROL, param, true, CallBackCgg_sec_perfil_rol);
                } catch (inErr) {
                    winFrmCgg_sec_perfil_rol.getEl().unmask();
                }
            }
    ...
    /**
     * Boton que permite cancelar los cambios de la informacion de la ventana winFrmCgg_sec_perfil_rol.
     */
    ...
    /**
     * Boton que permite cerrar la ventana winFrmCgg_sec_perfil_rol.
     */
    ...
    /**
     * Ext.form.FormPanel Panel principal que contiene los controles de la ventana winFrmCgg_sec_perfil_rol.
     */
     ...
     */
    var winFrmCgg_sec_perfil_rol = new Ext.Window({
        id: 'winFrmCgg_sec_perfil_rol',
        title: tituloCgg_sec_perfil_rol,
    ...
    /**
     * Funcion que permite habilitar los controles que contienen la informacion de la ventana winFrmCgg_sec_perfil_rol.
    ...
    /**
     * Funcion que permite cargar la informacion de los controles de la ventana winFrmCgg_sec_perfil_rol.
     */
    ...
    function cargarCgg_sec_perfil_rolCtrls() {
        if (inRecordCgg_sec_perfil_rol) {
            ...
            tmpPerfil = inRecordCgg_sec_perfil_rol.get('CSPRF_CODIGO');
            isEdit = true;
            habilitarCgg_sec_perfil_rolCtrls(true);
        }
    }
    /**
     * Funcion miembro que devuelve la ventana winFrmCgg_sec_perfil_rol.
     * @returns ventana winFrmCgg_sec_perfil_rol.
     * @base FrmCgg_sec_perfil_rol.prototype.show
     */
    this.getWindow = function () {
        return winFrmCgg_sec_perfil_rol;
    }
    /**
     * Funcion miembro que carga los controles de la ventana winFrmCgg_sec_perfil_rol.
     * @base FrmCgg_sec_perfil_rol.prototype.loadData
     */
	...
	*/
	this.setPerfil = function(inPerfil){
		tmpPerfil = inPerfil;
	}
}
/**
 * Funcion prototipo. Permite mostrar la ventana winFrmCgg_sec_perfil_rol desde una instancia.
 */
FrmCgg_sec_perfil_rol.prototype.setPerfil = function (inPerfil) {
    this.setPerfil(inPerfil);
}
/**
 * Funcion prototipo. Permite mostrar la ventana winFrmCgg_sec_perfil_rol desde una instancia.
 */
FrmCgg_sec_perfil_rol.prototype.show = function () {
    this.getWindow().show();
}
/**
 *Funcion prototipo. Permite cerrar la ventana winFrmCgg_sec_perfil_rol desde una instancia.
 */
FrmCgg_sec_perfil_rol.prototype.close = function () {
    this.getWindow().close();
}
/**
 * Funcion prototipo. Permite saber si se ha cerrado la ventana winFrmCgg_sec_perfil_rol,
 * con el fin de realizar otras acciones desde una instancia.
 */
FrmCgg_sec_perfil_rol.prototype.closeHandler = function (inFunctionHandler) {
    this.getWindow().on('close', inFunctionHandler);
}
/**
 * Funcion prototipo. Permite cargar los controles de la ventana winFrmCgg_sec_perfil_rol desde una instancia.
 */
FrmCgg_sec_perfil_rol.prototype.loadData = function () {
    this.loadData();
}