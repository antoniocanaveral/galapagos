 ...
 */
function FrmCgg_res_persona(INSENTENCIA_CGG_RES_PERSONA,INRECORD_CGG_RES_PERSONA){
    ...
    /**
     * Boton que permite almacenar la informacion de la ventana winFrmCgg_res_persona
     */
        ...
        listeners:{
            click:function(){
                ...
                try{
                    ...
                    winFrmCgg_res_persona.getEl().mask('Guardando...', 'x-mask-loading');
                    var tmpMetodo = null;
                    var fDefuncion = null;
    ...
    /**
     * Boton que permite cancelar los cambios de la informacion de la ventana winFrmCgg_res_persona.
     */
                    ...
                    if (btn=='yes')
                    {
                        try{
                            ...
                            if(seleccionado)
                            {
                                ...
                                winFrmCgg_res_persona.getEl().mask('Eliminando...', 'x-mask-loading');
	...
	*/
     ...
     * @base FrmCgg_res_persona.prototype.show
     */
     ...
     * @base FrmCgg_res_persona.prototype.loadData
     */
 ...
 */
FrmCgg_res_persona.prototype.show = function(){
    this.getWindow().show();
 ...
 */
FrmCgg_res_persona.prototype.close = function(){
 ...
 */
FrmCgg_res_persona.prototype.closeHandler = function(inFunctionHandler){
    this.getWindow().on('close',inFunctionHandler);
}
/**
 * Funcion prototipo. Permite cargar los controles de la ventana winFrmCgg_res_persona desde una instancia.
 */
FrmCgg_res_persona.prototype.loadData = function(){
    this.loadData();
}
 ...
 * Funcion prototipo. Permite cargar los controles de la ventana winFrmCgg_res_persona desde una instancia.
 */
FrmCgg_res_persona.prototype.loadData1 = function(){
    this.loadData1();
}