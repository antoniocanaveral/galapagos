function FrmCgg_canton_noti_offline(){
    var optMenu = 'Offline/Base E/S persona';
    var Canton_offline = null;
	 
    var btnSalirCgg_canton_noti_offline = new Ext.Button({
        id:'btnSalirFrmCgg_canton_noti_offline',
        text: 'Salir',
        iconCls: 'iconSalir',
        tooltip:'Cierra el formulario actual',
        handler:function(){
            winFrmCgg_canton_noti_offline.close();
        }
    });

    var btnDescargarCgg_canton_noti_offline = new Ext.Button({
        id:'btnDescargarFrmCgg_canton_noti_offline',
        text: 'Descargar',
        ...
        handler:function(){
            if(Canton_offline){
                ...
                var url = 'https://'+ URL_SERVER +URL_WS+'/PublicWS/DatosConfigNotificacionSRV?tipo=file&in_Canton='+Canton_offline;
 ...
 */
    var winFrmCgg_canton_noti_offline = new Ext.Window({
        id:'winFrmCgg_canton_noti_offline',
        title:'Cant\u00f3',
        iconCls:'iconOffline',
        width:420,
        height:150,
        ...
        bbar:[btnDescargarCgg_canton_noti_offline,'->',btnSalirCgg_canton_noti_offline]
    });

    /**
 *Devuelve la ventada del objecto FrmCgg_canton_noti_offline.
 */
    this.getWindow = function(){
        return winFrmCgg_canton_noti_offline;
    } 
 ...
 */
FrmCgg_canton_noti_offline.prototype.show = function(){
    this.getWindow().show();
}
