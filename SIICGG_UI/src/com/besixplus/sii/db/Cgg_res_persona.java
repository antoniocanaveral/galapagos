...
public class Cgg_res_persona implements Serializable{
	...
	/**
	 * CONTRUCTOR DE LA CLASE Cgg_res_persona.
	 */
	...
	*/
	...
	/**
	 * CONTABILIZA CUANTOS REGISTROS EXISTEN EN LA TABLA Cgg_res_persona.
	 * @param inConnection CONEXION A LA BASE DE DATOS.
	...
	*/
	 ...
	 * @return ArrayList<com.besixplus.sii.objects.Cgg_res_persona> VECTOR DE OBJETOS EQUIVALENTE A LOS REGISTROS DE LA TABLA.
	 */
	public static ArrayList<HashMap<String,Object>> selectPersonaNotificacion(
			java.sql.Connection inConnection,
			String inUserName,
			int inStart,
			int inLimit,
	 ...
	 * @return int NUMERO DE REGISTROS.
	 */
	public static int selectCountNotificacion(
			java.sql.Connection inConnection,
			String inKeyword
	){
		int outCount = 0;
	 ...
	 * @return int NUMERO DE REGISTROS.
	 */
	public static int selectDenunciaCount(
			java.sql.Connection inConnection,
			String inKeyword
	){
		int outCount = 0;
	...
	*/
	 ...
	 * @return com.besixplus.sii.objects.Cgg_res_persona OBJETO EQUIVALENTE AL REGISTRO DE LA TABLA.
	 */
	public com.besixplus.sii.objects.Cgg_res_persona selectNumDocHistorial(
			java.sql.Connection inConnection
	){
		try{
			...
			while (results.next()) {
				this.getCgg_res_persona().setCRPER_CODIGO(results.getString(1));
				this.getCgg_res_persona().setCRECV_ESTADO_CIVIL(results.getString(2));
				this.getCgg_res_persona().setCRDID_TIPO(results.getString(3));
				this.getCgg_res_persona().setCGNCN_NOMBRE(results.getString(4));
				this.getCgg_res_persona().setCPRR_NOMBRE(results.getString(5));
				this.getCgg_res_persona().setCCNT_NOMBRE(results.getString(6));
				this.getCgg_res_persona().setCCNT_NOMBRE_ORIGEN(results.getString(7));
				this.getCgg_res_persona().setCRPER_NOMBRES(results.getString(8));
				this.getCgg_res_persona().setCRPER_APELLIDO_PATERNO(results.getString(9));
				this.getCgg_res_persona().setCRPER_APELLIDO_MATERNO(results.getString(10));
				this.getCgg_res_persona().setCRPER_NUM_DOC_IDENTIFIC(results.getString(11));
				this.getCgg_res_persona().setCRPER_FECHA_NACIMIENTO(results.getTimestamp(12));
				this.getCgg_res_persona().setCRPER_LUGAR_NACIMIENTO(results.getString(13));
				this.getCgg_res_persona().setCRPER_GENERO(results.getInt(14));
				this.getCgg_res_persona().setCRPER_NUMERO_RESIDENCIA(results.getString(15));
				this.getCgg_res_persona().setCRPER_AUTORIZADO(results.getBoolean(16));
				this.getCgg_res_persona().setCRPER_TIPO_PERSONA(results.getInt(17));
				this.getCgg_res_persona().setCRPER_TIPO(results.getInt(18));
				this.getCgg_res_persona().setCRPER_ESTADO(results.getBoolean(19));
			}
			results.close();
			stmSelect.close();
		}catch(SQLException e){
	...
	/**
	 * SELECCIONA UN REGISTRO DE LA TABLA Cgg_res_movilidad DE ACUERDO A SU CODIGO.
	 * @param inConnection CONEXION A LA BASE DE DATOS.
	 * @return com.besixplus.sii.objects.Cgg_res_persona OBJETO EQUIVALENTE AL REGISTRO DE LA TABLA.
	 */
	...
	public static ArrayList<HashMap<String,Object>> selectPersonaHistorialMovilidadIngreso(
		java.sql.Connection inConnection,
		String inCrper_codigo
		
	){
		ArrayList<HashMap<String,Object>> outCgg_res_movilidad_ingreso = new ArrayList<HashMap<String,Object>>();
			try{
	...
	public static ArrayList<HashMap<String,Object>> selectPersonaHistorialMovilidadGeneral(
		java.sql.Connection inConnection,
		String inCrper_codigo,
		ArrayList<HashMap<String,Object>>  inCgg_res_movilidad	
	){
	...
	/**
	 * SELECCIONA UN REGISTRO DE LA TABLA Cgg_res_movilidad_interna DE ACUERDO A SU NUMERO DE DOCUMENTO.
	 * @param inConnection CONEXION A LA BASE DE DATOS.
	 * @return com.besixplus.sii.objects.Cgg_res_persona OBJETO EQUIVALENTE AL REGISTRO DE LA TABLA.
	 */
	...
	public static ArrayList<HashMap<String,Object>> selectPersonaHistorialMovilidadInternaIngreso(
		java.sql.Connection inConnection,
		String inCrper_codigo
		
	){
		ArrayList<HashMap<String,Object>> outCgg_res_movilidad_interna_ingreso = new ArrayList<HashMap<String,Object>>();
			try{
	...
	public static ArrayList<HashMap<String,Object>> selectPersonaHistorialMovilidadInterna(
		java.sql.Connection inConnection,
		String inCrper_codigo,
		ArrayList<HashMap<String,Object>> inCgg_res_movilidad_interna
