...
public class Cgg_sec_objeto_rol implements Serializable{
	private static final long serialVersionUID = 823804513;
	/**
	...
	*/
	...
	/**
	* CONTRUCTOR DE LA CLASE Cgg_sec_objeto_rol.
	*/
	...
	*/
	public String insert(
		...
		try{
			...
			stmInsert.setBoolean(6, this.getCgg_sec_objeto_rol().getCSBJR_ESTADO());
			stmInsert.setString(7, this.getCgg_sec_objeto_rol().getCSBJR_USUARIO_INSERT());
			stmInsert.execute();
	...
	public static ArrayList<com.besixplus.sii.objects.Cgg_sec_objeto_rol> selectAll(
		...
		try{
			...
			while (results.next()) {
				...
				tmpCgg_sec_objeto_rol.setCSBJR_ESTADO(results.getBoolean(5));
	...
	*/
	public static ArrayList<com.besixplus.sii.objects.Cgg_sec_objeto_rol> selectAll(
		...
		try{
			...
			stmSelect.setString(9, inKeyword);
			stmSelect.execute();
			ResultSet results = (ResultSet) stmSelect.getObject(1);
			while (results.next()) {
				com.besixplus.sii.objects.Cgg_sec_objeto_rol tmpCgg_sec_objeto_rol = new com.besixplus.sii.objects.Cgg_sec_objeto_rol();
	...
	*/
	public String update(
		...
		try{
			...
			stmUpdate.setBoolean(5, this.getCgg_sec_objeto_rol().getCSBJR_ESTADO());
			stmUpdate.setString(6, this.getCgg_sec_objeto_rol().getCSBJR_USUARIO_UPDATE());
	...
	public com.besixplus.sii.objects.Cgg_sec_objeto_rol select(
		...
		try{
			...
			while (results.next()) {
				...
				this.getCgg_sec_objeto_rol().setCSBJR_ESTADO(results.getBoolean(5));
			}
			results.close();
			stmSelect.close();
		}catch(SQLException e){
