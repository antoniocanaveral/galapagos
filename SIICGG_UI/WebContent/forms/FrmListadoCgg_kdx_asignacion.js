 ...
 */
function FrmListadoCgg_kdx_asignacion(inDescktop){
    var optMenu = 'Kardex/Asignaci\u00f3n';
    var urlListadoCgg_kdx_asignacion=URL_WS+"Cgg_kdx_asignacion";
    var tituloListadoCgg_kdx_asignacion='Asignaci\u00f3n de especies';
    var descListadoCgg_kdx_asignacion='El formulario permite administrar informaci\u00f3n de Asignaci\u00f3n de especies';
    /**
     * Ext.Button Boton que permite insertar un nuevo registro de la ventana winFrmListadoCgg_kdx_asignacion.
     */
    ...
    /**
     * Ext.Button Boton que permite editar un registro de la ventana winFrmListadoCgg_kdx_asignacion.
     */
    ...
    /**
     * Ext.Button Boton que permite eliminar un registro de la ventana winFrmListadoCgg_kdx_asignacion.
     */
                ...
                function SWRCgg_kdx_asignacion(btn){if (btn=='yes'){
                    try{
                        function CallBackCgg_kdx_asignacion(r){
                            winFrmListadoCgg_kdx_asignacion.getEl().unmask();
                            if(r=='true'){
                                Ext.Msg.show({
                        ...
                        winFrmListadoCgg_kdx_asignacion.getEl().mask('Eliminando...', 'x-mask-loading');
    ...
    /**
     * Ext.Button Boton que permite salir de la ventana winFrmListadoCgg_kdx_asignacion.
     */
    var btnSalirCgg_kdx_asignacion = new Ext.Button({
        ...
        listeners:{
            click:function(){
                winFrmListadoCgg_kdx_asignacion.close();
            }}
    });
    /**
     * Ext.Button Boton para obtener reportes, general o individual.
     */var btnReporteCgg_kdx_asignacion = new Ext.Button({
        id:'btnReporteCgg_kdx_asignacion',
        name:'btnReporteCgg_kdx_asignacion',
        text:'Reportes',
        ...
        menu:[
            {text:'Acta Entrega',
                handler:function(){
                    var r=grdCgg_kdx_asignacion.getSelectionModel().getSelected();
                    if(r){
                        if (r.get("CKASG_ESTADO_ASIGNACION")  == TypeEstadoAsignacion.REGISTRADA)
                        {
                            var urlReport = new Reporte('rptActaEntregaRecepcion','/Reports/sii/kardex',{P_CKASG_CODIGO:r.get("CKASG_CODIGO")});
                            urlReport.show();
                        }
                    }
    ...
    var gsCgg_kdx_asignacion = new Ext.data.GroupingStore({
        ...
        sortInfo:{field: 'CKASG_FECHA_RECEPCION', direction: 'DESC'},
     ...
     */
    if(inDescktop){
        var winFrmListadoCgg_kdx_asignacion = inDescktop.createWindow({
            id:'winFrmListadoCgg_kdx_asignacion',
            title:tituloListadoCgg_kdx_asignacion,
            ...
            bbar:[btnNuevoCgg_kdx_asignacion,'-',btnReporteCgg_kdx_asignacion,'->',btnSalirCgg_kdx_asignacion]
        });
        /**
         * Funcion que aplica los privilegios del usuario.
         */
        applyGrants(winFrmListadoCgg_kdx_asignacion.getBottomToolbar());
    }
    /**
     * Funcion miembro que devuelve la ventana winFrmListadoCgg_kdx_asignacion.
     * @returns ventana winFrmCgg_kdx_asignacion.
     * @base FrmListadoCgg_kdx_asignacion.prototype.show
     */
    this.getWindow = function(){
        return winFrmListadoCgg_kdx_asignacion;
    }
    /**
     * Funcion miembro que carga los controles de la ventana winFrmListadoCgg_kdx_asignacion.
     * @base FrmListadoCgg_kdx_asignacion.prototype.loadData
     */
 ...
 */
FrmListadoCgg_kdx_asignacion.prototype.getColumnModel = function(){
    this.getColumnModel();
}
/**
 * Funcion prototipo. Devuelve el Store utilizado en el formulario.
 */
FrmListadoCgg_kdx_asignacion.prototype.getStore = function(){
    this.getStore();
}
/**
 * Funcion prototipo. Permite mostrar la ventana winFrmListadoCgg_kdx_asignacion desde una instancia.
 */
FrmListadoCgg_kdx_asignacion.prototype.show = function(){
    this.getWindow().show();
}
/**
 * Funcion prototipo. Permite cerrar la ventana winFrmListadoCgg_kdx_asignacion desde una instancia.
 */
FrmListadoCgg_kdx_asignacion.prototype.close = function(){
    this.getWindow().close();
}
/**
 * Funcion prototipo. Permite saber si se ha cerrado la ventana winFrmListadoCgg_kdx_asignacion,
 * con el fin de realizar otras acciones desde una instancia.
 */
FrmListadoCgg_kdx_asignacion.prototype.closeHandler = function(inFunctionHandler){
    this.getWindow().on('close',inFunctionHandler);
}
/**
 * Funcion prototipo. Permite cargar los controles de la ventana winFrmListadoCgg_kdx_asignacion desde una instancia.
 */
FrmListadoCgg_kdx_asignacion.prototype.loadData = function(){
    this.loadData();
}
