...
VALUES(SII.F_KEYGEN('CGG_MIGRATIONSCRIPT','MRGSP_CODIGO','MRGSP'), current_timestamp,'ADMIN', current_timestamp,'ADMIN', current_timestamp,
	true,'acanaveral','TRAMITES USUARIOS FINALES','Modifica la funcion que permite desplegar los tramites realizados por un usuario. Para que además se visualicen los tramites de usuarios finales de esa isla',
