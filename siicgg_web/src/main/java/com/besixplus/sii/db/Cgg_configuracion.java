...
public class Cgg_configuracion implements Serializable{
	...
	*/
	...
	/**
	* CONTRUCTOR DE LA CLASE Cgg_configuracion.
	*/
	...
	*/
	public boolean insert(
		...
		try{
			...
			stmInsert.setBigDecimal(5, this.getCgg_configuracion().getCGCNF_VALOR_NUMERICO());
	...
	public static ArrayList<com.besixplus.sii.objects.Cgg_configuracion> selectAll(
		...
		try{
			...
			while (results.next()) {
				...
				tmpCgg_configuracion.setCGCNF_VALOR_NUMERICO(results.getBigDecimal(4));
	...
	*/
	public boolean update(
		...
		try{
			...
			stmUpdate.setBigDecimal(4, this.getCgg_configuracion().getCGCNF_VALOR_NUMERICO());
	...
	public com.besixplus.sii.objects.Cgg_configuracion select(
		...
		try{
			...
			while (results.next()) {
				...
				this.getCgg_configuracion().setCGCNF_VALOR_NUMERICO(results.getBigDecimal(4));
