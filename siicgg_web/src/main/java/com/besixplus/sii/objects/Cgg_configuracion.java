...
public class Cgg_configuracion implements Serializable{
	...
	*/
	private java.math.BigDecimal myCgcnf_valor_numerico;
	/**
	* ESTADO DEL REGISTRO
	*/
	...
	*/
	public Cgg_configuracion(
		...
		java.math.BigDecimal inCgcnf_valor_numerico,
	...
	* @param incgcnf_valor_numerico VALOR DE CONFIGURACION TIPO NUMERICO
	*/
	public void setCGCNF_VALOR_NUMERICO(java.math.BigDecimal inCgcnf_valor_numerico){
	...
	*/
	public java.math.BigDecimal getCGCNF_VALOR_NUMERICO(){
