...
1 - FEMENINO
	...
	*/
	private byte[] myCrper_huella_dactilar;
	/**
	...
	*/
	...
	/**
	* TEXTO QUE REPRESENTA LA HUELLA CAPTURADA. ESTE TEXTO ES VARIABLE.
	*/
...
1 - FEMENINO
	...
	*/
	...
	/**
	* ESTABLECE HUELLA DACTILAR DE LA PERSONA
	* @param incrper_huella_dactilar HUELLA DACTILAR DE LA PERSONA
	*/
	public void setCRPER_HUELLA_DACTILAR(byte[] inCrper_huella_dactilar){
		this.myCrper_huella_dactilar = inCrper_huella_dactilar;
	}
	/**
	* OBTIENE HUELLA DACTILAR DE LA PERSONA
	* @return byte[] HUELLA DACTILAR DE LA PERSONA
	*/
	public byte[] getCRPER_HUELLA_DACTILAR(){
	...
	*/
	...
	/**
	* ESTABLECE TEXTO QUE REPRESENTA LA HUELLA CAPTURADA. ESTE TEXTO ES VARIABLE.
	* @param incrper_huella_cadena TEXTO QUE REPRESENTA LA HUELLA CAPTURADA. ESTE TEXTO ES VARIABLE.
	*/
	...
	/**
	* OBTIENE TEXTO QUE REPRESENTA LA HUELLA CAPTURADA. ESTE TEXTO ES VARIABLE.
	* @return String TEXTO QUE REPRESENTA LA HUELLA CAPTURADA. ESTE TEXTO ES VARIABLE.
	*/
...
1 - REGULAR
	...
	*/
	 ...
	 * @param incrper_estado_ DESCRIPCION DEL ESTADO CIVIL
	 */
	 ...
	 * @param inCrper_myCrper_tipo_documento DESCRIPCION DE LA NACIONALIDAD
	 */
	 ...
	 * @param inCrper_canton DESCRIPCION DEL CANTON
	 */
