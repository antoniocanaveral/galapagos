                            ...
                            <tr height="25px">
                                ...
                                <td width="142" rowspan="2" align="left" valign="bottom"><img
                                    ...
                                    <div class="clsAcceso" align="center"><a href="/sii"
                                                                             style="font-size: 11px">Acceso a siicgg</a>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td valign="top" width=200 style="min-width: 180px;"><!--Area de la fecha-->
                                    ...
                                    <div id="lnkAccesoLogin" style="display: none">Click
                                        aqu&iacute; para ingresar al sistema
                                    </div>
                                    <div id="divLogin" class="login"
                                        ...
                                        <table width="100%">
                                            <tr>
                                                <td>
                                                    <div id="btnCambiarClave" style="float: left" class="linkNormal">
                                                        Cambiar
                                                        clave
                                                    </div>
                                                </td>
                                    ...
                                    <div id="pnlGestionEmpleo" class="login" style="display: none">
                                        <div id="loading" class="cargandoIcon"
                                             style="text-indent: 20px; height: 100%">Cargando...
                                        </div>
                                                    ...
                                                    <div style="max-width: 175px">
                                                        <ul>
                                                            <li id="linkCandidatos"
                                                                style="list-style-image: url(css/icon/group.png);">
                                                                Buscar
                                                                empleo
                                                            </li>
                                                            ...
                                                            <li
                                                                ...
                                                                &nbsp;</li>
                                                            <li id="linkContacto"
                                                                style="list-style-image: url(css/icon/book_open.png);">
                                                                Cont&aacute;ctenos
                                                            </li>
                                                            <li id="linkPreguntas"
                                                                style="list-style-image: url(css/icon/comment.png);">
                                                                Preg.
                                                                Frecuentes
                                                            </li>
                                                    ...
                                                    <div style="max-width: 175px">
                                                        <ul>
                                                            <li id="linkBecaBeneficiario"
                                                                style="list-style-image: url(css/icon/newspaper.png);">
                                                                Beneficiarios
                                                                de becas
                                                            </li>
                                                            <li id="linkPreregistrocurso"
                                                                style="list-style-image: url(css/icon/ico_inscripcion.gif);">
                                                                Pre-inscripci&oacute;n
                                                                curso
                                                            </li>
                                                            <li
                                                                    style="margin-bottom: 0px 5px 10px 0px; width: 120px; cursor: default; list-style-type: none; border-bottom: 1px dotted #EE8E41">
                                                    ...
                                                    <div style="height: 100%;">
                                                        <ul>
                                                            ...
                                                            <li id="btnConsultaTramites"
                                                                style="list-style-image: url(css/icon/buscar.png);">
                                                                Consulta
                                                                tr&aacute;mites
                                                            </li>
                                                            <li id="btnRequisitosTramites"
                                                                style="list-style-image: url(css/icon/requisitos.png);">
                                                                Requisitos
                                                            </li>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                ...
                                <td width="354" align="left" valign="middle">
                                    ...
                                    <div class="divAcercaDe" align="left">
                                        <div align="left"><b>Oficina Matriz: Isla San Crist&oacute;bal</b></div>
                                    </div>
                                    <div class="divAcercaDe" align="left">
                                        <div align="left">Av. 12 de Febrero, V&iacute;a el Progreso (Cerro Patricio)
                                        </div>
                                    </div>
                                </td>
                                <td width="203">&nbsp;</td>
