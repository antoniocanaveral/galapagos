...
public class Cgg_res_fase implements Serializable{
	private static final long serialVersionUID = 1683873685;
	/**
	...
	*/
	public Cgg_res_fase(
		...
		boolean inCrfas_ejecuta_despacho,
		boolean inCrfas_atencion_normal,
		...
		this.setCRFAS_EJECUTA_DESPACHO(inCrfas_ejecuta_despacho);
		this.setCRFAS_ATENCION_NORMAL(inCrfas_atencion_normal);
