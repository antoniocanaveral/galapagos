...
* TABLA: OBJETO
* DESCRIPCION: CONTIENE LOS OBJETOS QUE AUTORIZAN UN ROL
* ABREVIATURA:CSBJR
*/
public class Cgg_sec_objeto_rol implements Serializable{
	private static final long serialVersionUID = 1222487775;
	/**
	...
	*/
	private String myCsbjr_acceso_directo_texto;
	/**
	* ESTADO DEL REGISTRO
	*/
	...
	* @param inCsbjr_acceso_directo_texto TEXTO DEL ACCESO DIRECTO. SOLO ES APLICABLE A LOS OBJETOS VISUALES.
	...
	*/
	public Cgg_sec_objeto_rol(
		...
		String inCsbjr_acceso_directo_texto,
		...
		this.setCSBJR_ACCESO_DIRECTO_TEXTO(inCsbjr_acceso_directo_texto);
	...
	* @param inCsbjr_acceso_directo_texto TEXTO DEL ACCESO DIRECTO. SOLO ES APLICABLE A LOS OBJETOS VISUALES.
	*/
	public void setCSBJR_ACCESO_DIRECTO_TEXTO(String inCsbjr_acceso_directo_texto){
		this.myCsbjr_acceso_directo_texto = inCsbjr_acceso_directo_texto;
	}
	/**
	* OBTIENE TEXTO DEL ACCESO DIRECTO. SOLO ES APLICABLE A LOS OBJETOS VISUALES.
	* @return String TEXTO DEL ACCESO DIRECTO. SOLO ES APLICABLE A LOS OBJETOS VISUALES.
	*/
	public String getCSBJR_ACCESO_DIRECTO_TEXTO(){
		return this.myCsbjr_acceso_directo_texto;
	}
