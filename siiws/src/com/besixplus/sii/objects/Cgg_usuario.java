...
public class Cgg_usuario implements Serializable{
	private static final long serialVersionUID = 2005724916;
	/**
...
EXTERNO
	...
	*/
	...
	/**
	* SI EL USUARIO DEBE CAMBIAR LA CLAVE DE ACCESO EN EL SIGUIENTE INGRESO.
	*/
...
EXTERNO
	...
	* @param inCusu_cambiar_clave SI EL USUARIO DEBE CAMBIAR LA CLAVE DE ACCESO EN EL SIGUIENTE INGRESO.
	...
	*/
	public Cgg_usuario(
		...
		this.setCUSU_CAMBIAR_CLAVE(inCusu_cambiar_clave);
...
EXTERNO
	...
	*/
	...
	/**
	* ESTABLECE SI EL USUARIO DEBE CAMBIAR LA CLAVE DE ACCESO EN EL SIGUIENTE INGRESO.
	* @param inCusu_cambiar_clave SI EL USUARIO DEBE CAMBIAR LA CLAVE DE ACCESO EN EL SIGUIENTE INGRESO.
	*/
	...
	/**
	* OBTIENE SI EL USUARIO DEBE CAMBIAR LA CLAVE DE ACCESO EN EL SIGUIENTE INGRESO.
	* @return boolean SI EL USUARIO DEBE CAMBIAR LA CLAVE DE ACCESO EN EL SIGUIENTE INGRESO.
	*/
