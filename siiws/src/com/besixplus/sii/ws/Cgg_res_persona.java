...
1 - REGULAR.
	...
	public String insert(
		...
		obj.setCRPER_FOTO(org.jboss.util.Base64.decode(inCrper_foto));
		obj.setCRPER_FOTO_CURRICULUM(org.jboss.util.Base64.decode(inCrper_foto_curriculum));
		obj.setCRPER_HUELLA_DACTILAR(inCrper_huella_dactilar);
		obj.setCRPER_HUELLA_IMAGEN(org.jboss.util.Base64.decode(inCrper_huella_imagen));
		obj.setCRPER_HUELLA_CADENA(inCrper_huella_cadena);
		obj.setCRPER_FIRMA(org.jboss.util.Base64.decode(inCrper_firma));
		...
		obj.setCRPER_ADJUNTO_ACTA(org.jboss.util.Base64.decode(inCrper_adjunto_acta));
...
1 - IRREGULAR
	...
	public String updateHuellaImagen(
		...
		try{
			...
			tmpPersona.setCRPER_HUELLA_IMAGEN(org.jboss.util.Base64.decode(inCrper_huella_imagen));
	...
	public String updateFirma(
		...
		try{
			...
			com.besixplus.sii.objects.Cgg_res_persona tmpPersona = new com.besixplus.sii.objects.Cgg_res_persona();
			tmpPersona.setCRPER_CODIGO(inCrper_codigo);
			tmpPersona.setCRPER_FIRMA(org.jboss.util.Base64.decode(inCrper_firma));
