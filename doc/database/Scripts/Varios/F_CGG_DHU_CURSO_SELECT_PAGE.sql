/**
* FUNCION F_CGG_DHU_CURSO_SELECT_PAGE
...
CREATE OR REPLACE FUNCTION sii.f_cgg_dhu_curso_select_page(in_user_name character varying, in_start_index integer, in_limit integer, in_sort_field_name character varying, in_direction character varying, in_find_text text)
...
BEGIN
	...
	WHERE CDCUR_ESTADO = TRUE  AND SII.F_STRING_IN('''||IN_FIND_TEXT||''',
