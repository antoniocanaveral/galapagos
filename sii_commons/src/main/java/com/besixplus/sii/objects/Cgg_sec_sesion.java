...
* TABLA: SESION
* DESCRIPCION:ALMACENA INFORMACION DE LAS CONEXIONES DEL USUARIO AL SISTEMA
* ABREVIATURA:CSSSN
*/
public class Cgg_sec_sesion implements Serializable{
	...
	*/
	...
	/** OBTIENE  LA SESION QUE ASIGNA EL SERVIDOR DE APLICACIONES
	 * @return  SESION QUE ASIGNA EL SERVIDOR DE APLICACIONES
	 */
	public HttpSession getHTTP_SESSION() {
		return myHttpSession;
	}
	/**
	 * ESTABLECE LA SESION QUE ASIGNA EL SERVIDOR DE APLICACIONES
	 * @param inHttpSession  SESION QUE ASIGNA EL SERVIDOR DE APLICACIONES
	 */
	 ...
	 * @param inCusuNombreUsuario NOMBRE USUARIO
	 */
