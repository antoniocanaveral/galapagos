...
* ABREVIATURA:CUSU
*/
public class Cgg_usuario_persona implements Serializable{
...
EXTERNO
	...
	*/
	 ...
	 * @return 	String NOMBRE DE LA PERSON
	 */
	public String getCRPER_NOMBRES() {
		return myCrper_nombres;
	}
	/**
	...
	public String getCRPER_APELLIDO_PATERNO() {
		return myCrper_apellido_paterno;
	}
	/**
	 * ESTABLECE EL APELLIDO PATERNO DE LA PERSONA
	 * @param inCrper_apellido_paterno
	 */
	...
	public String getCRPER_APELLIDO_MATERNO() {
		return myCrper_apellido_materno;
	}
	/**
	 * ESTABLECE EL APELLIDO MATERNO DE LA PERSONA
	 * @param inCrper_apellido_materno APELLIDO MATERNO DE LA PERSONA
	 */
	...
	public String getCRPER_NOMBRE_PERSONA() {
		return myCrper_nombre_persona;
	}
	/**
	 * ESTABLECE EL NOMBRE DE LA PERSONA
	 * @param inCrper_nombre_persona NOMBRE DE LA PERSONA
	 */
	public void setCRPER_NOMBRE_PERSONA(String inCrper_nombre_persona) {
		this.myCrper_nombre_persona = inCrper_nombre_persona;
	}
	/**
	 * OBTIENE EL IDENTIFICATIVO UNICO DE ISLA
	 * @return String IDENTIFICATIVO UNICO DE ISLA
	 */
	public String getCISLA_CODIGO() {
		return myCisla_codigo;
	}
	/**
	 * ESTABLECE IDENTIFICATIVO UNICO DE ISLA
